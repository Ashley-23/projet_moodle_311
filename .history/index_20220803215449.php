                ...
                <div class="columns is-desktop is-align-items-center">
                    ...
                    <div class="column is-6-desktop">
                        <div class="about-item">
                            ...
                            <p class="mb-5" La plupart des formations en présentiel se font en groupe et obligent à suivre un rythme imposé par un professeur. Il y a un programme et des horaires stricts à suivre et à tenir, ce qui ne laisse pas le choix à l’apprenant de choisir la manière dont il veut apprendre. Nous vous permettons de suivre les cours dans un délai donné mais en vous donnant la possibilité d'aller à votre rythme. </p>
                    ...
                    <div class="column is-4-desktop is-6-tablet">
                        <div class="card has-text-centered mb-lg-0 mb-3" data-aos="fade-down" data-aos-delay="100">
                            <div class="py-6">
                                ...
                                <a href="/moodle/local/moodlepe/register/index.php?offre=1" class="btn btn-solid-border mt-5 ">Souscrire</a>
                            </div>
                        </div>
                    </div>
                    <div class="column is-4-desktop is-6-tablet">
                        <div class="card has-text-centered mb-lg-0 mb-3 " data-aos="fade-down" data-aos-delay="300">
                            <div class="py-6">
                                ...
                                <a href="/moodle/local/moodlepe/register/index.php?offre=2" class="btn btn-main mt-5">Souscrire</a>
                            </div>
                        </div>
                    </div>
                    <div class="column is-4-desktop is-6-tablet">
                        <div class="card has-text-centered mb-lg-0 mb-3" data-aos="fade-down" data-aos-delay="500">
                            <div class="py-6">
                                ...
                                <a href="/moodle/local/moodlepe/register/index.php?offre=3" class="btn btn-solid-border mt-5">Souscrire</a>
                            </div>
                        </div>
                    </div>
                </div>
