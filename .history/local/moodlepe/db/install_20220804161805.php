...
function xmldb_local_moodlepe_install()
{
    ...
    $check_role_username = $mysql->query("SELECT * FROM mdl_role WHERE name='$role_name' AND shortname='$role_shortname' AND description ='$role_description'", MYSQLI_USE_RESULT);
