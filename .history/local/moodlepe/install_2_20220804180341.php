...
$allow_assign1  = "INSERT INTO mdl_role_allow_assign (roleid, contextlevel) VALUES ('$verify_role_id', '$allowassign1')";

$mysql->query($allow_assign1);

// allow_assign2

$allow_assign2  = "INSERT INTO mdl_role_allow_assign (roleid, contextlevel) VALUES ('$verify_role_id', '$allowassign2')";

$mysql->query($allow_assign2);

// allow_assign

$allow_assign  = "INSERT INTO mdl_role_allow_assign (roleid, contextlevel) VALUES ('$verify_role_id', '$allowassign')";

$mysql->query($allow_assign);
