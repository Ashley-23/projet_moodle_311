...
$contextlevel1 = "10";
// $context_level1  = "INSERT INTO mdl_role_context_levels (roleid, contextlevel) VALUES ('$verify_role_id', '$conte

// $my_Db_Connection = new PDO($sql, $username, $password, $dsn_Options);

// recupération de l'id du rôle qu'on vient de créer

// $check_role_id = query("SELECT * FROM mdl_role WHERE name='$role_name' AND shortname='$role_shortname' AND description ='$role_description'");
