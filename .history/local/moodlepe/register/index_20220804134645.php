...
if (!isset($_GET['erreur'])) {
	...
	if ($erreur == "echec") {
		...
		// EMAIL EXISTE DEJA 
		$email_errormessage = "! Le nom et le prénom saisis existent déjà";
	} else if ($erreur == "usernameerror") {
		// USERNAME EXISTE DEJA 
		$username_errormessage = "! Le nom et le prénom saisis existent déjà";
	} else if ($erreur == "entrepriseerror") {
		// ENTREPRISE EXISTE DEJA
		$entreprise_errormessage = "! Le nom et le prénom saisis existent déjà";
	}
}
            ...
            <li class="list-group-item d-flex justify-content-between">
              ...
              <strong> 0 </strong>
				...
				<form method="POST" action="/moodle/local/moodlepe/register/index2.php">
					...
					<span style="color:red">
						<i class="fas fa-times bg-pink3"></i> <?php echo $lastorfirstnameerror; ?> </span>
