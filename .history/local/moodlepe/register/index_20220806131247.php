            ...
            <li class="list-group-item d-flex justify-content-between">
              ...
              <strong> 0 </strong>
				...
				<form method="POST" action="/moodle/local/moodlepe/register/index2.php">
					...
					!--ENVOIE DE L 'OFFRE CHOISI POUR POUVOIR REVENIR SUR CETTE PAGE EN CAS D'
					ERREUR-- > < !-- < div> -- >
						< button type="submit" class="form-control"> Valider < i class="zmdi zmdi-arrow-right">
								< /i>
									< / button>

										< button type="reset" class="form-control"> Annuler < i class="zmdi zmdi-arrow-right">
												< /i>
													< / button>
														< !-- < input type="reset" value="Annuler"> -- >
															< !-- < /div> --> < p>
																	< a href="/moodle/index.php"> Retourner à l 'accueil</a> </p>
