              ...
              <strong> 0 </strong>
				...
				<form method="POST" action="/moodle/local/moodlepe/register/index2.php">
					...
					<span style="color:red">
						<i class="fas fa-times bg-pink3"></i> <?php echo $errormessage; ?> </span>
					<!-- span -->
					...
					<span style="color:red">
						<i class="fas fa-times bg-pink3"></i> <?php echo $nomprenom_errormessage; ?> </span>
					<div class="form-wrapper">
						<input type="text" placeholder="Nom d'utilisateur" class="form-control" required name="username">
						<i class="zmdi zmdi-account"></i>
					</div>
					<span style="color:red">
						<i class="fas fa-times bg-pink3"></i> <?php echo $username_errormessage; ?> </span>
					<!-- span -->
					<div class="form-wrapper">
					...
					<span style="color:red">
						<i class="fas fa-times bg-pink3"></i> <?php echo $email_errormessage; ?> </span>
					<!-- span -->
					<!-- 	<div class="form-wrapper">
					...
					<span style="color:red">
						<i class="fas fa-times bg-pink3"></i> <?php echo $entreprise_errormessage; ?> </span>
					<!-- span -->
					...
					<input type="hidden" value="<?php $offer_id ?>" name="offre" disabled>
