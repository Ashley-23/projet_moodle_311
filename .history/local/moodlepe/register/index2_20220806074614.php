...
if (isset($_POST['userfirstname']) || isset($_POST['userlastname']) || isset($_POST['username']) || isset($_POST['useremail']) || isset($_POST['userentreprise1']) || isset($_POST['userentreprise2']) || isset($_POST['userpassword1']) || isset($_POST['userpassword2']) || isset($_POST['offre'])) {
	...
	if ($entreprise1 == $entreprise2 && $mdp1 == $mdp2) {
		...
		$row10 = $check_user_email->fetch_array(MYSQLI_ASSOC);
		$verify_email = $row10["email"];
		...
		echo "</br> username : " . $verify_user_username;
		echo "</br> firstname : " . $verify_user_firstname;
		echo "</br> lastname : " . $verify_user_lastname;
		echo "</br> email saisi : " . $verify_user_email;
		echo "</br> email : " . $verify_user_email;
		echo "</br> email : " . $verify_email;
		echo "</br> cohort name  : " . $verify_email;
		die();
